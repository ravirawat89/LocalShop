...
public class ShopOwnerActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.shop_owner, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_ShopOwner_slideshow) {

        } else if (id == R.id.nav_ShopOwner_manage) {

        } else if (id == R.id.nav_ShopOwner_share) {

        } else if (id == R.id.nav_ShopOwner_send) {
